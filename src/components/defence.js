...
const Defence = (props) => {
        ...
        return (
            <div className='equip-main'>
                <div className={details ? 'equip-true' : 'equip-false'}>
                    ...
                    <div className={details ? "equip-img_true-div" : "equip-img_false-div"}><img src={imgDefence[index]} alt={el.name} /></div>
    ...
    return (
        <div className="content">
            ...
            {props.planet.defence.map((ship, index) => (
                <div key={index} className='equip'>{DefenceElement(ship, index)}</div>
            ))}
        </div>
    )
}
